      ...
      <View style={styles.frame}>
        <View style={styles.conteiner}>
          ...
          <TouchableOpacity style={[styles.button, styles.bgEasy]} onPress={()=>props.onLevelSelected(0.1)}>
            <Text style={styles.buttonLabel}>Facíl</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={[styles.button, styles.bgImpossible]} onPress={()=>props.onLevelSelected(0.5)}>
            <Text style={styles.buttonLabel}>Impossívell</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
