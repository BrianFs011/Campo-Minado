...
import { createMinedBoard, cloneBoard, openField, hasExplosion, showMines, wonGame, invertFlag, flagsUsed } from './src/functions';
    ...
    return(
      <View style={styles.conteiner}>
        ...
        <View style={styles.board}>
          <MinesField board={this.state.board} onOpenField={this.onOpenField} onSelectField={this.onSelectField}/>
        </View>
      </View>
    )
  }
